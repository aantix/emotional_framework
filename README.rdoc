...
It's important to note that the question is "could *you* let go".  The question moves the power to the person pondering.  The power to release troublesome thoughts lies within the person; it's not the case that the thoughts are troubling the person.  
